...
if __name__ == '__main__':
    ...
    assert parse_cookie('name=Name;age=99;bday=01.01.1920') == {'name': 'Name', 'age': '99',
                                                                    'bday': '01.01.1920'}
    assert parse_cookie('name=Name;bday=01.01.1920;email=name@mail.com') == {'name': 'Name', 'bday': '01.01.1920',
                                                                    'email': 'name@mail.com'}
    print('Ok2')